...
|---|---|---|---|---|---|---|
| `0.9.925` | `v1` | `chaptarr/chaptarr:0.9.925@sha256:8e29f4941acaf74c80bba4322237dfd2549816b3dd1b581f176b1be5d1ccb46b` | pinned-contract | live-verified | `chaptarr_tag`, `chaptarr_api_info`, `chaptarr_system_status` | Disposable tag CRUD/import plus API/system reads passed locally against this exact image digest on 2026-08-10; CI re-verifies each provider head. |
...
The provider contract is Chaptarr `0.9.925` (`v0.9.925`, commit `29853a2e4024b61857bfd64be200832beabf6938`). It records 30 implemented resource targets and 38 implemented data-source targets. Representative acceptance proves only tag lifecycle and safe API/system reads; it does not claim live coverage of every target.
