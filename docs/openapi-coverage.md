...
| `DELETE /api/v1/customfilter/{id}` | CustomFilter | resource | implemented | chaptarr_custom_filter | #7 | `e8bfeed5d96b` |
...
| `DELETE /api/v1/importlist/{id}` | ImportList | resource | implemented | chaptarr_import_list | #6 | `55643a331e28` |
...
| `DELETE /api/v1/importlistexclusion/{id}` | ImportListExclusion | resource | implemented | chaptarr_import_list_exclusion | #6 | `0696490068e7` |
...
| `DELETE /api/v1/releaseprofile/{id}` | ReleaseProfile | resource | implemented | chaptarr_release_profile | #4 | `dc08eccf2d7b` |
...
| `DELETE /api/v1/settings/proxy/{id}` | Proxy | resource | implemented | chaptarr_proxy | #7 | `f951e710fe0d` |
...
| `DELETE /api/v1/tag/{id}` | Tag | resource | implemented | chaptarr_tag | #7 | `0389dacc955d` |
...
| `GET /api/v1/customfilter/{id}` | CustomFilter | resource | implemented | chaptarr_custom_filter | #7 | `5e53161e4b68` |
| `GET /api/v1/customformat` | CustomFormat | resource | planned | chaptarr_custom_format | #7 | `324cb80f7d59` |
| `GET /api/v1/customformat/schema` | CustomFormat | data-source | implemented | chaptarr_custom_format_schema | #7 | `965f4fd22baa` |
| `GET /api/v1/customformat/{id}` | CustomFormat | resource | implemented | chaptarr_custom_format | #7 | `9c103e6c51f4` |
...
| `GET /api/v1/importlist/schema` | ImportList | data-source | implemented | chaptarr_import_list_schema | #6 | `036c31d67780` |
| `GET /api/v1/importlist/{id}` | ImportList | resource | implemented | chaptarr_import_list | #6 | `c5fa781b6539` |
| `GET /api/v1/importlistexclusion` | ImportListExclusion | resource | planned | chaptarr_import_list_exclusion | #6 | `3c7d7b55e1e3` |
| `GET /api/v1/importlistexclusion/{id}` | ImportListExclusion | resource | implemented | chaptarr_import_list_exclusion | #6 | `774d1086a0da` |
...
| `GET /api/v1/metadata/schema` | Metadata | data-source | implemented | chaptarr_metadata_schema | #7 | `cf380bfc3e4f` |
| `GET /api/v1/metadata/{id}` | Metadata | resource | implemented | chaptarr_metadata | #7 | `03f22a530414` |
| `GET /api/v1/metadataprofile` | MetadataProfile | resource | planned | chaptarr_metadata_profile | #4 | `f96cd7a03ddb` |
| `GET /api/v1/metadataprofile/languages` | MetadataProfile | data-source | implemented | chaptarr_metadata_profile_schema | #4 | `fa074c5e1b22` |
...
| `GET /api/v1/qualitydefinition` | QualityDefinition | resource | implemented | chaptarr_quality_definition | #4 | `187c275e2a44` |
| `GET /api/v1/qualitydefinition/{id}` | QualityDefinition | resource | implemented | chaptarr_quality_definition | #4 | `19af7037fb85` |
| `GET /api/v1/qualityprofile` | QualityProfile | resource | planned | chaptarr_quality_profile | #4 | `a71a0ea426a5` |
| `GET /api/v1/qualityprofile/schema` | QualityProfileSchema | data-source | implemented | chaptarr_quality_profile_schema | #4 | `06d14457231a` |
| `GET /api/v1/qualityprofile/{id}` | QualityProfile | resource | implemented | chaptarr_quality_profile | #4 | `eb50c19bfe2b` |
...
| `GET /api/v1/settings/proxy/{id}` | Proxy | resource | implemented | chaptarr_proxy | #7 | `91251ce8ddcb` |
...
| `GET /api/v1/tag/detail` | TagDetails | data-source | implemented | chaptarr_tag_details | #7 | `b8372219ea39` |
| `GET /api/v1/tag/detail/{id}` | TagDetails | data-source | implemented | chaptarr_tag_details | #7 | `2df6abb4c360` |
| `GET /api/v1/tag/{id}` | Tag | resource | implemented | chaptarr_tag | #7 | `3dd144b8d94f` |
...
| `POST /api/v1/importlist` | ImportList | resource | implemented | chaptarr_import_list | #6 | `782ff6fb78f4` |
...
| `POST /api/v1/importlistexclusion` | ImportListExclusion | resource | implemented | chaptarr_import_list_exclusion | #6 | `c69177671dba` |
...
| `POST /api/v1/metadata` | Metadata | resource | implemented | chaptarr_metadata | #7 | `da8c1bf7cdaa` |
...
| `POST /api/v1/qualityprofile` | QualityProfile | resource | implemented | chaptarr_quality_profile | #4 | `91d5abe03ab2` |
...
| `POST /api/v1/releaseprofile` | ReleaseProfile | resource | implemented | chaptarr_release_profile | #4 | `2d53117fcb9f` |
...
| `PUT /api/v1/customfilter/{id}` | CustomFilter | resource | implemented | chaptarr_custom_filter | #7 | `74102fb555af` |
| `PUT /api/v1/customformat/{id}` | CustomFormat | resource | implemented | chaptarr_custom_format | #7 | `f85c846dac80` |
...
| `PUT /api/v1/importlist/{id}` | ImportList | resource | implemented | chaptarr_import_list | #6 | `f5a9777b6207` |
| `PUT /api/v1/importlistexclusion/{id}` | ImportListExclusion | resource | implemented | chaptarr_import_list_exclusion | #6 | `320543b7f313` |
...
| `PUT /api/v1/releaseprofile/{id}` | ReleaseProfile | resource | implemented | chaptarr_release_profile | #4 | `a3670037f70a` |
...
| `PUT /api/v1/settings/proxy/{id}` | Proxy | resource | implemented | chaptarr_proxy | #7 | `4d282f29fe51` |
| `PUT /api/v1/tag/{id}` | Tag | resource | implemented | chaptarr_tag | #7 | `8c393913c2f9` |
